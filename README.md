...
This plugin also previews these boosts before you turn them on: hovering a prayer shows what it would add to each affected stat, and hovering an attack style shows its hidden stance bonus, right in the game's own tooltips.
...
* Show prayer tooltip boost
* Show attack style tooltip boost
